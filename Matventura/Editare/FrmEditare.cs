    ...
    public partial class FrmEditare : Form
    {
        ...
        private void FrmEditare_Load(object sender, EventArgs e)
        {
            ...
            while (r.Read())
            {
                ...
                lbID.Items.Add(r["ID_Lupta"].ToString());
        ...
        private void pbAdaugare_Click(object sender, EventArgs e)
        {
            OleDbConnection con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data source=" + cale + "\\Soft.accdb");
            con.Open();
            string qs = "Insert into Intrebari (Exercitiu,R1,R2,R3,RCorect,ID_Lupta) values(@int,@R1,@R2,@R3,@RC,@ID_Lupta)";
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            OleDbConnection con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data source=" + cale + "\\Soft.accdb");
            con.Open();
            string qs = "Update Intrebari SET Exercitiu=@exercitiu,R1=@R1,R2=@R2,R3=@R3,RCorect=@RC where ID_Lupta=@ID_Lupta";
            OleDbCommand com = new OleDbCommand(qs, con);
            com.Parameters.AddWithValue("Exercitiu", tbIntrebare.Text);
            com.Parameters.AddWithValue("R1", tbr1.Text);
            com.Parameters.AddWithValue("R2", tbr2.Text);
            ...
            com.Parameters.AddWithValue("ID_Lupta", lbID.Items[lbIntrebari.SelectedIndex].ToString());
            com.ExecuteNonQuery();
            con.Close();
            incarca_intrebare();
